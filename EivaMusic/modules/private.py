...
import logging
from EivaMusic.modules.msg import Messages as tr
from pyrogram import Client
from pyrogram import filters
from pyrogram.types import InlineKeyboardMarkup
from pyrogram.types import InlineKeyboardButton
from pyrogram.types import Message
from EivaMusic.config import SOURCE_CODE
from EivaMusic.config import ASSISTANT_NAME
from EivaMusic.config import PROJECT_NAME
from EivaMusic.config import SUPPORT_GROUP
from EivaMusic.config import UPDATES_CHANNEL
from EivaMusic.config import BOT_USERNAME
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🟡 Click here for help 🟡", url=f"https://t.me/{venomxt_musicbot}?start"
                    )
                ]
            ]
        ),
