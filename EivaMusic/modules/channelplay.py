...
from EivaMusic.modules.play import generate_cover
from EivaMusic.modules.play import arq
from EivaMusic.modules.play import cb_admin_check
from EivaMusic.modules.play import transcode
from EivaMusic.modules.play import convert_seconds
from EivaMusic.modules.play import time_to_seconds
from EivaMusic.modules.play import changeImageSize
from EivaMusic.config import BOT_NAME as bn
from EivaMusic.config import DURATION_LIMIT
from EivaMusic.config import UPDATES_CHANNEL as updateschannel
from EivaMusic.config import que
from EivaMusic.function.admins import admins as a
from EivaMusic.helpers.errors import DurationLimitError
from EivaMusic.helpers.decorators import errors
from EivaMusic.helpers.admins import get_administrators
from EivaMusic.helpers.channelmusic import get_chat_id
from EivaMusic.helpers.decorators import authorized_users_only
from EivaMusic.helpers.filters import command
from EivaMusic.helpers.filters import other_filters
from EivaMusic.helpers.gets import get_file_name
from EivaMusic.services.callsmusic import callsmusic
from EivaMusic.services.callsmusic import client as USER
from EivaMusic.services.converter.converter import convert
from EivaMusic.services.downloaders import youtube
from EivaMusic.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/d841fe226646016f829e7.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Eivamusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/d841fe226646016f829e7.jpg"
